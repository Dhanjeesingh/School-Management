...
public partial class exam_type : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            conn.Open();
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "Insert into exam_type values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox4.Text + "')";
            cmd.ExecuteNonQuery();
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            conn.Open();
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "Update exam_type set name='" + TextBox2.Text + "',desc1='" + TextBox4.Text + "'where exam_type_id='" + TextBox1.Text + "'";
            cmd.ExecuteNonQuery();
